...
class CompilerIntegrationTests: XCTestCase {
    ...
    func testReturnGenericClassValue() {
        ...
        _ = integrationTests.returnGenericClassValue(value: sendValue)(nil, { value, unit in
    ...
    func testReturnDefaultValue() {
        ...
        _ = integrationTests.returnDefaultValue(value: sendValue)(nil, { value, unit in
    ...
    func testReturnGenericValue() {
        ...
        let valueExpectation = expectation(description: "Waiting for value")
        let sendValue = NSNumber(value: randomInt())
        _ = integrationTests.returnGenericValue(value: sendValue)(nil, { value, unit in
            XCTAssertEqual(value as! NSNumber, sendValue, "Received incorrect value")
            valueExpectation.fulfill()
            return unit
        }, { _, unit in unit }, { _, unit in unit })
    ...
    func testReturnConstrainedGenericValue() {
        ...
        _ = integrationTests.returnConstrainedGenericValue(value: sendValue)(nil, { value, unit in
    ...
    func testReturnGenericValues() {
        ...
        _ = integrationTests.returnGenericValues(values: sendValues)(nil, { values, unit in
    ...
    func testReturnGenericVarargValues() {
        ...
        _ = integrationTests.returnGenericVarargValues(values: sendValues)(nil, { values, unit in
    ...
    func testReturnGenericValueFromExtension() {
        ...
        let valueExpectation = expectation(description: "Waiting for value")
        let sendValue = NSNumber(value: randomInt())
        _ = integrationTests.returnGenericValueFromExtension(receiver: [], value: sendValue)(nil, { value, unit in
            XCTAssertEqual(value as! NSNumber, sendValue, "Received incorrect value")
            valueExpectation.fulfill()
            return unit
        }, { _, unit in unit }, { _, unit in unit })
    ...
    func testReturnGenericFlow() {
        ...
        let valueExpectation = expectation(description: "Waiting for value")
        let sendValue = NSNumber(value: randomInt())
        _ = integrationTests.returnGenericFlow(value: sendValue)(nil, { value, next, _ in
            XCTAssertEqual(value as! NSNumber, sendValue, "Received incorrect value")
            valueExpectation.fulfill()
            return next()
        }, { _, unit in unit }, { _, unit in unit })
