...
class NewMemoryModelIntegrationTests: XCTestCase {
    ...
    func testReturnMutableData() {
        ...
        _ = integrationTests.generateRandomMutableDataNative()({ value, unit in
            ...
            XCTAssertEqual(value.dataFromMain, dataFromBackground, "Data from background should now be data from main")
