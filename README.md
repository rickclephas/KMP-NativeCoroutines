...
|----------------|-------------------|:----------:|:----------:|:----------:|
| 1.0.0-ALPHA-28 | -kotlin-2.0.0-RC3 | 2.0.0-RC3  |   1.0.20   |   1.8.1    |
| **_latest_**   | **_no suffix_**   | **1.9.24** | **1.0.20** | **1.8.1**  |
...
```swift
dependencies: [
    .package(url: "https://github.com/rickclephas/KMP-NativeCoroutines.git", exact: "1.0.0-ALPHA-30")
],
targets: [
    .target(
        name: "MyTargetName",
...
```ruby
pod 'KMPNativeCoroutinesAsync', '1.0.0-ALPHA-30'    # Swift Concurrency implementation
pod 'KMPNativeCoroutinesCombine', '1.0.0-ALPHA-30'  # Combine implementation
pod 'KMPNativeCoroutinesRxSwift', '1.0.0-ALPHA-30'  # RxSwift implementation
```
> [!NOTE]
