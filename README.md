...
|----------------|-----------------|:---------:|:----------:|
| **_latest_**   | **_no suffix_** | **2.4.0** | **1.10.1** |
...
```ruby
pod 'KMPNativeCoroutinesAsync', git: 'https://github.com/rickclephas/KMP-NativeCoroutines.git', tag: 'v1.0.4'   # Swift Concurrency implementation
pod 'KMPNativeCoroutinesCombine', git: 'https://github.com/rickclephas/KMP-NativeCoroutines.git', tag: 'v1.0.4' # Combine implementation
pod 'KMPNativeCoroutinesRxSwift', git: 'https://github.com/rickclephas/KMP-NativeCoroutines.git', tag: 'v1.0.4' # RxSwift implementation
```
> [!NOTE]
