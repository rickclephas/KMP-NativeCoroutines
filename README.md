...
```ruby
pod 'KMPNativeCoroutinesAsync', '1.0.0-ALPHA-27'    # Swift Concurrency implementation
pod 'KMPNativeCoroutinesCombine', '1.0.0-ALPHA-27'  # Combine implementation
pod 'KMPNativeCoroutinesRxSwift', '1.0.0-ALPHA-27'  # RxSwift implementation
```
> [!NOTE]
