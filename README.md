...
|----------------|-------------------|:----------:|:----------:|:----------:|
| 1.0.0-ALPHA-28 | -kotlin-2.0.0-RC2 | 2.0.0-RC2  |   1.0.20   |   1.8.0    |
| **_latest_**   | **_no suffix_**   | **1.9.24** | **1.0.20** | **1.8.0**  |
...
plugins {
    ...
    id("com.rickclephas.kmp.nativecoroutines") version "1.0.0-ALPHA-29"
}
```
...
```swift
dependencies: [
    .package(url: "https://github.com/rickclephas/KMP-NativeCoroutines.git", exact: "1.0.0-ALPHA-29")
],
targets: [
    .target(
        name: "MyTargetName",
...
```ruby
pod 'KMPNativeCoroutinesAsync', '1.0.0-ALPHA-29'    # Swift Concurrency implementation
pod 'KMPNativeCoroutinesCombine', '1.0.0-ALPHA-29'  # Combine implementation
pod 'KMPNativeCoroutinesRxSwift', '1.0.0-ALPHA-29'  # RxSwift implementation
```
> [!NOTE]
