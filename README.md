...
|----------------|---------------------|:-----------:|:----------:|:----------:|
| _latest_       | -kotlin-2.0.0-Beta5 | 2.0.0-Beta5 |   1.0.17   |   1.8.0    |
| **_latest_**   | **_no suffix_**     | **1.9.23**  | **1.0.20** | **1.8.0**  |
...
```swift
dependencies: [
    .package(url: "https://github.com/rickclephas/KMP-NativeCoroutines.git", exact: "1.0.0-ALPHA-28")
],
targets: [
    .target(
        name: "MyTargetName",
...
```ruby
pod 'KMPNativeCoroutinesAsync', '1.0.0-ALPHA-28'    # Swift Concurrency implementation
pod 'KMPNativeCoroutinesCombine', '1.0.0-ALPHA-28'  # Combine implementation
pod 'KMPNativeCoroutinesRxSwift', '1.0.0-ALPHA-28'  # RxSwift implementation
```
> [!NOTE]
