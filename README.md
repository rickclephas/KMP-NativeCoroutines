...
|----------------|-----------------|:----------:|:----------:|
| **_latest_**   | **_no suffix_** | **2.3.10** | **1.10.1** |
...
```ruby
pod 'KMPNativeCoroutinesAsync', '1.0.1'    # Swift Concurrency implementation
pod 'KMPNativeCoroutinesCombine', '1.0.1'  # Combine implementation
pod 'KMPNativeCoroutinesRxSwift', git: 'https://github.com/rickclephas/KMP-NativeCoroutines.git', tag: 'v1.0.1' # RxSwift implementation
```
> [!NOTE]
