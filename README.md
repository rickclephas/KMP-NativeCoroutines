...
|----------------|---------------------|:----------:|:----------:|
| **_latest_**   | **_no suffix_**     | **2.2.21** | **1.10.1** |
...
```ruby
pod 'KMPNativeCoroutinesAsync', '1.0.0-ALPHA-48'    # Swift Concurrency implementation
pod 'KMPNativeCoroutinesCombine', '1.0.0-ALPHA-48'  # Combine implementation
pod 'KMPNativeCoroutinesRxSwift', git: 'https://github.com/rickclephas/KMP-NativeCoroutines.git', tag: 'v1.0.0-ALPHA-48' # RxSwift implementation
```
> [!NOTE]
