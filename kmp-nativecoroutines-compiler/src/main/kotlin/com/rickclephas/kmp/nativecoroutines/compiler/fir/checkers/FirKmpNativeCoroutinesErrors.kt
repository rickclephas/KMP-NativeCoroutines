...
public object FirKmpNativeCoroutinesErrors {
    ...
    public val EXPOSED_FLOW_TYPE: KtDiagnosticFactory0 by warning0<PsiElement>()
    public val EXPOSED_FLOW_TYPE_ERROR: KtDiagnosticFactory0 by error0<PsiElement>()
    public val EXPOSED_STATE_FLOW_PROPERTY: KtDiagnosticFactory0 by warning0<PsiElement>()
    public val EXPOSED_STATE_FLOW_PROPERTY_ERROR: KtDiagnosticFactory0 by error0<PsiElement>()
    public val EXPOSED_SUSPEND_FUNCTION: KtDiagnosticFactory0 by warning0<PsiElement>()
    public val EXPOSED_SUSPEND_FUNCTION_ERROR: KtDiagnosticFactory0 by error0<PsiElement>()
