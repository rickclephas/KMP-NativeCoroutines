...
internal object DefaultErrorMessages : DefaultErrorMessages.Extension {
    override fun getMap(): DiagnosticFactoryToRendererMap = DiagnosticFactoryToRendererMap("KmpNativeCoroutines").apply {
        ...
        put(REDUNDANT_OVERRIDE_COROUTINES_REFINED, "NativeCoroutinesRefined isn't supported on overridden declarations")
        put(REDUNDANT_OVERRIDE_COROUTINES_REFINED_STATE, "NativeCoroutinesRefinedState isn't supported on overridden declarations")
